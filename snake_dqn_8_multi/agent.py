...
class Agent:
    ...
    def __init__(
        ...
        self.model = DQN(output_size=action_size, grid_size=grid_size).to(self.device)
        self.target_model = DQN(output_size=action_size, grid_size=grid_size).to(self.device)
